...
if sure == 'y':
    ...
    employees = {'SG1':SG1, 'RC':RC, 'IE':IE, 'MM3':MM3, 'JC':JC, 'NC':NC, 'DD':DD, 'SB':SB, 'DL':DL, 'RS':RS, 'SLL':SLL, 'JA1':JA1, 'JG':JG, 'EG':EG, 'AI':AI, 'EG':EG, 'LA':LA, 'FG':FG, 'TA':TA, 'RR':RR, 'JA4':JA4, 'JA3':JA3, 'BA':BA, 'TT':TT, 'KK':KK, 'SS':SS, 'PP':PP, 'TG':TG}
